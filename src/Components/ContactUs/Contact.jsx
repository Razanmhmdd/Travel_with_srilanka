...
const Contact = () => {
  return (
    <div className="flex flex-col md:flex-row bg-amber-50 p-6 md:p-12">
      {/* Contact Form */}
      <div className="w-full md:w-1/2 mb-6 md:mb-0">
        ...
        <form className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full bg-amber-500 text-white font-semibold p-2 rounded-md hover:bg-amber-600 transition duration-200"
          >
            Send Message
          </button>
        </form>
